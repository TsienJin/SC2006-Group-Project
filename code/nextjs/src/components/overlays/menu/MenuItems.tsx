...
import {clearThenAddToStack, sideBarDispatch, sideBarStatesEnum} from '@/components/slice/sideBar'
...
const TestItem = () => {
  ...
  return (
    <MenuItemWrapper handler={()=>menuItemClick(dispatch, sideBarStatesEnum.Test)}>
        <VectorWrapper>
